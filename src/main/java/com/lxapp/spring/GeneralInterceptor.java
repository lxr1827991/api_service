...
public class GeneralInterceptor extends HandlerInterceptorAdapter{  
    ...
    public boolean preHandle(HttpServletRequest request,    
     ...
     appInterface.setUid(request.getParameter("sysUid"));
     appInterface.setVersion(request.getParameter("sysVersion"));
     appInterface.setAppid(request.getParameter("sysAppid"));
     AppUtils.setAppInterfaces(appInterface);
